...
actions:
  - type: open
    link: "[[/01 Daily/2025/09-September/2025-09-30-Tuesday]]"
    newTab: false
```
```meta-bind-button
id: current-week 
...
actions:
  - type: open
    link: "[[/01 Daily/2025/10-October/2025-10-02-Thursday]]"
    newTab: false
```
